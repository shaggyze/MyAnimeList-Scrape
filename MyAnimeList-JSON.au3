...
$REGKEY="HKEY_CURRENT_USER\Software\ShaggyZE\MyAnimeList-JSON\"
	...
	Switch $nMsg
		...
		Case $ButtonS
			...
			If $Method = "MAL-Anime" Then
				...
				FileDelete($szFile2)
				$Template = GUICtrlRead($TemplateINP)
				$szText = '/* Generated by MyAnimeList-JSON https://github.com/shaggyze/MyAnimeList-JSON' & @CRLF & 'Template=' & $Template & '*/'
...
$readtitle = _StringBetween($read, '<div id="sarea', '">')
If $readtitle[0] = "" Then $readtitle[0] = "1"
$sValue2 = $readtitle[0]
GUICtrlSetData($ToINP, $readtitle[0])
EndFunc
